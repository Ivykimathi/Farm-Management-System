...
@frappe.whitelist()
def get_calendar_events(doctor=None):
    """
    ...
    try:
        ...
        treats = frappe.get_all("Treatment and Vaccination Logs", fields=["name", "specify_type_of_treatment", "doctor", "treatment_date", "poultry_batch_under_treatment", "animal_under_medication", "cattle_shed_under_treatment", "specific_cattle_under_treatment"], filters=filters, limit_page_length=2000)
        for t in treats:
            try:
