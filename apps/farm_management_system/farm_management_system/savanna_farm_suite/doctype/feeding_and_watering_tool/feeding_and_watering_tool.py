...
def create_nourishment_logs(
    ...
    specify_sheep_shed=None,
    specify_rabbit_shed=None,
    specify_pig_shed=None,
    specify_goat_shed=None,
    ...
    Args:
        ...
        user (str)
        table_rows (json-stringified list)
        poultry_batch (optional)
        poultry_house (optional)
        specify_cattle_shed (optional)
        specify_sheep_shed (optional)
        specify_rabbit_shed (optional)
        specify_pig_shed (optional)
        specify_goat_shed (optional)
        incl_hydration (bool)
    Returns:
    ...
    if poultry_batch:
        ...
        try:
            ...
            denom = None
    elif specify_sheep_shed:
        try:
            denom = frappe.db.count("Sheep", {"sheep_shed": specify_sheep_shed})
        except Exception:
            denom = None
    elif specify_rabbit_shed:
        try:
            denom = frappe.db.count("Rabbit", {"rabbit_shed": specify_rabbit_shed})
        except Exception:
            denom = None
    elif specify_pig_shed:
        try:
            denom = frappe.db.count("Pig", {"pig_shed": specify_pig_shed})
        except Exception:
            denom = None
    elif specify_goat_shed:
        try:
            denom = frappe.db.count("Goat", {"goat_shed": specify_goat_shed})
        except Exception:
            denom = None
    ...
    for row in rows:
        ...
        new_doc = frappe.get_doc({
            ...
            "poultry_batch": poultry_batch,
            "log_for_poultry_shed": poultry_house,
            "log_intended_for_cattle_shed": specify_cattle_shed,
            "log_intended_for_sheep_shed": specify_sheep_shed,
            "log_intended_for_rabbit_shed": specify_rabbit_shed,
            "log_intended_for_pig_shed": specify_pig_shed,
            "log_intended_for_goat_shed": specify_goat_shed,
