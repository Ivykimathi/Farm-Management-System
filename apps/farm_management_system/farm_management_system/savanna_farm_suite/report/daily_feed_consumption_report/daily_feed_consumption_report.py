...
def execute(filters=None):
    ...
    columns = [
        ...
        {"label": "Log intended for Sheep Shed", "fieldname": "log_intended_for_sheep_shed", "fieldtype": "Link","options": "Sheep Shed" , "width": 180},
        {"label": "Log intended for Rabbit Shed", "fieldname": "log_intended_for_rabbit_shed", "fieldtype": "Link","options": "Rabbit Shed" , "width": 180},
        {"label": "Log intended for Pig Shed", "fieldname": "log_intended_for_pig_shed", "fieldtype": "Link","options": "Pig Shed" , "width": 180},
        {"label": "Log intended for Goat Shed", "fieldname": "log_intended_for_goat_shed", "fieldtype": "Link","options": "Goat Shed" , "width": 180},
    ...
    fetch_fields = [
        ...
        "log_intended_for_sheep_shed",
        "log_intended_for_rabbit_shed",
        "log_intended_for_pig_shed",
        "log_intended_for_goat_shed",
        "feed_issued",
        "animal_feed_name",
        "default_uom",
        "qty_issued",
